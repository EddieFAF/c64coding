...
message	!scr "dies sollte ein beispiel text sein. hier koennte auch ein laengerer text erfolgen   "
          !byte $ff ; Endekennung

      *=$1000
music_data !bin "tune29.prg",,2

      *=$2000
!src "eddie_logo.txt"

      *=$1800
charset !bin "../../Resources/Fonts/aeg_collection_03.64c",,2
