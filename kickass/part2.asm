...
.var C_MUSIC_LOCATION        = $1000
.var C_MUSIC_INIT            = $1000
.var C_MUSIC_PLAY            = $1003
.var C_UNPACK_LOCATION       = $4000
...
render_messages:        lda message1,x
                        ...
                        lda #25                        // register music player interrupt
                        ldx #<update_music
                        ldy #>update_music
...
message2:               .byte 32, 32, 32, 32, 32, 32, 32, 32, 16, 18, 5, 19, 19, 32, 19, 16
                        .byte 1, 3, 5, 32, 20, 15, 32, 3, 15, 14, 20, 9, 14, 21, 5, 32
